                ...
                sshagent(credentials : ['app_server']) {
                     ...
                     if ( params.environment=='prod') {
                        ...
                        sh 'ssh -o StrictHostKeyChecking=no root@3.87.185.160 systemctl start goweb.service'
                         ...
                         sh 'whoami'
                         sh 'ssh -v -o StrictHostKeyChecking=no root@3.87.185.160 systemctl stop gostage.service'
                         ...
                         sh 'ssh -o StrictHostKeyChecking=no root@3.87.185.160 unzip -y /root/go/go-stage/${input}.zip'
                                }
                            }
                        }
                    }
